...
// Application Insights for Customer Function App (conditional)
resource customerFunctionAppInsights 'Microsoft.Insights/components@2020-02-02' = if (enableApplicationInsights) {
...
output appInsightsId string = enableApplicationInsights ? customerFunctionAppInsights!.id : ''
output appInsightsName string = enableApplicationInsights ? customerFunctionAppInsights!.name : ''
output appInsightsConnectionString string = enableApplicationInsights ? customerFunctionAppInsights!.properties.ConnectionString : ''
output appInsightsInstrumentationKey string = enableApplicationInsights ? customerFunctionAppInsights!.properties.InstrumentationKey : ''
