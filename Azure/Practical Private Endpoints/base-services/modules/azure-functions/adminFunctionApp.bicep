// Admin Function App Module - Handles admin management operations and background tasks
...
// Admin Function App
resource adminFunctionApp 'Microsoft.Web/sites@2023-01-01' = {
    ...
    privateLinkServiceConnections: [
      {
        ...
        properties: {
          privateLinkServiceId: adminFunctionApp.id
          groupIds: [
            'sites'
          ]
        }
...
// Outputs
output functionAppId string = adminFunctionApp.id
output functionAppName string = adminFunctionApp.name
output principalId string = adminFunctionApp.identity.principalId
output defaultHostName string = adminFunctionApp.properties.defaultHostName
...
output functionAppUrl string = 'https://${adminFunctionApp.properties.defaultHostName}'
