...
// Application Insights for Music Function App (conditional)
resource musicFunctionAppInsights 'Microsoft.Insights/components@2020-02-02' = if (enableApplicationInsights) {
...
output appInsightsId string = enableApplicationInsights ? musicFunctionAppInsights!.id : ''
output appInsightsName string = enableApplicationInsights ? musicFunctionAppInsights!.name : ''
output appInsightsConnectionString string = enableApplicationInsights ? musicFunctionAppInsights!.properties.ConnectionString : ''
output appInsightsInstrumentationKey string = enableApplicationInsights ? musicFunctionAppInsights!.properties.InstrumentationKey : ''
