// Video Function App Module - Handles video processing, streaming, and analytics operations
...
// Video Function App
resource videoFunctionApp 'Microsoft.Web/sites@2023-01-01' = {
...
// Application Insights for Video Function App (conditional)
resource videoFunctionAppInsights 'Microsoft.Insights/components@2020-02-02' = if (enableApplicationInsights) {
...
output appInsightsId string = enableApplicationInsights ? videoFunctionAppInsights!.id : ''
output appInsightsName string = enableApplicationInsights ? videoFunctionAppInsights!.name : ''
output appInsightsConnectionString string = enableApplicationInsights ? videoFunctionAppInsights!.properties.ConnectionString : ''
output appInsightsInstrumentationKey string = enableApplicationInsights ? videoFunctionAppInsights!.properties.InstrumentationKey : ''
